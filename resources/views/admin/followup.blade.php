...
<script>
    $(document).ready(function() {
        ...
        myTable = $('#NegativeHorizontalExample').DataTable({
            "scrollX": true,
        ...
        $('#NegativeHorizontalExample').on('click', '.show-more', function() {
        ...
        $('#NegativeHorizontalExample').on('click', '.show-less', function() {
            var $row = $(this).closest('tr');
            var $moreText = $row.find('.more-text');
            var $ellipsis = $row.find('.ellipsis');
        ...
        $('#NegativeHorizontalExample tbody').on('change', '.checkbox', function() {
            ...
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0">Conferences Followup Data <h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                <!-- <div class="d-flex align-items-center mb-3">
                    <label>
                        Show Enteries
                        <select name="NegativeHorizontalExample_length" aria-controls="NegativeHorizontalExample" class="form-select form-select-sm">
                ...
                <table id="NegativeHorizontalExample" class="table table-striped table-hover">

                    <!-- <table id="NegativeHorizontalExample" class="table table-striped table-bordered border-primary" style="width:100%">
            ...
            <!-- <div class="d-flex align-items-center">
                <div class="dataTables_info fs-7 fw-bold p-4" id="NegativeHorizontalExample_info" role="status" aria-live="polite">Showing 1 to 10 of 120,466 entries</div>
                <ul class="ms-auto position-relative pagination">
                    <li class="paginate_button page-item previous disabled" id="NegativeHorizontalExample_previous">
                        <a aria-controls="NegativeHorizontalExample" aria-disabled="true" role="link" data-dt-idx="previous" tabindex="-1" class="page-link">Previous</a>
                    </li>
                    <li class="paginate_button page-item active">
                        <a href="#" aria-controls="NegativeHorizontalExample" role="link" aria-current="page" data-dt-idx="0" tabindex="0" class="page-link">1</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="NegativeHorizontalExample" role="link" data-dt-idx="1" tabindex="0" class="page-link">2</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="NegativeHorizontalExample" role="link" data-dt-idx="2" tabindex="0" class="page-link">3</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="NegativeHorizontalExample" role="link" data-dt-idx="3" tabindex="0" class="page-link">4</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="NegativeHorizontalExample" role="link" data-dt-idx="4" tabindex="0" class="page-link">5</a>
                    </li>
                    <li class="paginate_button page-item disabled" id="NegativeHorizontalExample_ellipsis">
                        <a aria-controls="NegativeHorizontalExample" aria-disabled="true" role="link" data-dt-idx="ellipsis" tabindex="-1" class="page-link">…</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="NegativeHorizontalExample" role="link" data-dt-idx="12046" tabindex="0" class="page-link">12047</a>
                    </li>
                    <li class="paginate_button page-item next" id="NegativeHorizontalExample_next">
                        <a href="#" aria-controls="NegativeHorizontalExample" role="link" data-dt-idx="next" tabindex="0" class="page-link">Next</a>
                    </li>
                </ul>
            </div> -->
        </div>
