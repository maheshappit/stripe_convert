...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form class="form-horizontal" method="POST" action="{{ route('admin.postVerifyOTP') }}">
                {{ csrf_field() }}
                ...
                <button type="submit" class="btn btn-info ml-2" formaction="{{route('admin.resndOTP')}}" >Resend</button>
            </form>
        </div>
    </div>
</div>
