...
<script>
        $(document).ready(function() {
            ...
            $('#myForm').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('admin.save.newconference') }}',
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header py-3 bg-transparent">
                    <h5 class="mb-0">Create New Conference</h5>
                </div>
                <div class="card-body">
                    <div class="border p-3 rounded">
                        ...
                        <form id="myForm" class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Conference  Name">
                            </div>
