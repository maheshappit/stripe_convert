...
<div class="wrapper">
    ...
    <input type="date" id="email_sent_to_date" hidden name="email_sent_to_date" />
                                ...
                                <div class="col-12">
                                    <button id="mainSearch" class="btn btn-primary px-4">Search</button>


                                    <button id="ClearBtn" class="btn btn-warning px-4">Clear</button>
...
<button id="hiddenButton" class="btn btn-success" style="display: none;">Sent Email</button>
            ...
            <!-- <div class="d-flex align-items-center">
                <div class="dataTables_info fs-7 fw-bold p-4" id="dtHorizontalExample_info" role="status" aria-live="polite">Showing 1 to 10 of 120,466 entries</div>
                <ul class="ms-auto position-relative pagination">
                    <li class="paginate_button page-item previous disabled" id="dtHorizontalExample_previous">
                        <a aria-controls="dtHorizontalExample" aria-disabled="true" role="link" data-dt-idx="previous" tabindex="-1" class="page-link">Previous</a>
                    </li>
                    <li class="paginate_button page-item active">
                        <a href="#" aria-controls="dtHorizontalExample" role="link" aria-current="page" data-dt-idx="0" tabindex="0" class="page-link">1</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="dtHorizontalExample" role="link" data-dt-idx="1" tabindex="0" class="page-link">2</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="dtHorizontalExample" role="link" data-dt-idx="2" tabindex="0" class="page-link">3</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="dtHorizontalExample" role="link" data-dt-idx="3" tabindex="0" class="page-link">4</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="dtHorizontalExample" role="link" data-dt-idx="4" tabindex="0" class="page-link">5</a>
                    </li>
                    <li class="paginate_button page-item disabled" id="dtHorizontalExample_ellipsis">
                        <a aria-controls="dtHorizontalExample" aria-disabled="true" role="link" data-dt-idx="ellipsis" tabindex="-1" class="page-link">…</a>
                    </li>
                    <li class="paginate_button page-item ">
                        <a href="#" aria-controls="dtHorizontalExample" role="link" data-dt-idx="12046" tabindex="0" class="page-link">12047</a>
                    </li>
                    <li class="paginate_button page-item next" id="dtHorizontalExample_next">
                        <a href="#" aria-controls="dtHorizontalExample" role="link" data-dt-idx="next" tabindex="0" class="page-link">Next</a>
                    </li>
                </ul>
            </div> -->
        </div>
