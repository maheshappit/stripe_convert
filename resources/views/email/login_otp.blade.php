...
<html>
<head>
<title>{{ config('app.name') }} | OTP Confirmation</title>
</head>
<body>
...
<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p>Thank you for choosing {{ config('app.name') }}. Use the following OTP to complete your Sign in procedures. OTP is valid for 1 minutes</p>
